...
private
  ...
  def get_events
    ...
    require 'uri'
    require 'net/http'
    url = "http://venuedriver.com/api/venues/#{VENUE_DRIVER[:venue_id]_VENUE_ID}/events/select_tag.html?username=#{VENUE_DRIVER[:username]}&password=#{VENUE_DRIVER[:password]}"
